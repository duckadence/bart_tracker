...
let configuredStations = new Array(10).fill(null); // Local state for slots 1-10

// Update station dropdown and list when provider changes
providerSelect.addEventListener("change", () => {
  if (providerSelect.value === "custom") {
    apiUrl.classList.remove("hidden");
  } else {
